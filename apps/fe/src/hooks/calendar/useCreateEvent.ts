...
import type { CalendarEvent, CreateEventInput, EventQuery } from '@/types/api/productivity';
...
export function useCreateEvent(defaultQuery?: EventQuery) {
  ...
  return useMutation<TResponse<CalendarEvent>, Error, CreateEventVariables, CalendarCacheContext>({
