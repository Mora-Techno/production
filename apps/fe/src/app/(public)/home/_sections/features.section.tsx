...
import { Calendar, CheckSquare, FileText, Music2, Zap } from 'lucide-react';
...
const FEATURES = [
  ...
  },
  {
    icon: Music2,
    title: 'Focus Music',
    description: 'Playlist lo-fi Ghibli & Joe Hisaishi untuk menemani sesi kerja fokus kamu.',
  },
];
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-zinc-400">
            Satu platform untuk produktivitas harian — dari tugas hingga musik fokus, dirancang
            dengan estetika modern dark theme.
          </p>
        </div>
