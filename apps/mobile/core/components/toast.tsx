...
export const ToastContainer = ({ title, message, icon = 'info', onClose }: ToastContainerProps) => {
    ...
    >
      <View
        style={[
          styles.toast,
          {
            backgroundColor: isDark ? 'rgba(31, 41, 55, 0.9)' : iconData.bgColor,
      ...
      >
        ...
        <View style={styles.textContainer}>
          <Text style={[styles.title, { color: isDark ? '#f3f4f6' : iconData.textColor }]}>
            {title}
          </Text>
          <Text style={[styles.message, { color: isDark ? '#d1d5db' : iconData.textColor }]}>
            {message}
          </Text>
        </View>
      </View>
