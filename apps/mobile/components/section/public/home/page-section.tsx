...
import { ArrowRight, Home as HomeIcon, Shield, Smartphone, Zap } from 'lucide-react-native';
  ...
  return (
    ...
    >
      <View className="p-6 space-y-6">
            ...
            <CardContent className="pt-6">
              <View className="flex-row items-start">
                ...
                <View className="ml-4 flex-1">
                  <Text className="text-lg font-semibold mb-1">Lightning Fast</Text>
                  <Text className="text-gray-600 dark:text-gray-400">
                    Built with performance in mind. Experience smooth and responsive UI.
                  </Text>
                </View>
              </View>
            </CardContent>
          ...
          <Card className={isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}>
            <CardContent className="pt-6">
              <View className="flex-row items-start">
                ...
                <View className="ml-4 flex-1">
                  <Text className="text-lg font-semibold mb-1">Secure & Private</Text>
                  <Text className="text-gray-600 dark:text-gray-400">
          ...
          <Card className={isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}>
            <CardContent className="pt-6">
              <View className="flex-row items-start">
                ...
                <View className="ml-4 flex-1">
                  <Text className="text-lg font-semibold mb-1">Cross-Platform</Text>
                  <Text className="text-gray-600 dark:text-gray-400">
            ...
            <CardContent className="pt-6">
              <View className="flex-row flex-wrap gap-2">
                {[
                  ...
                  <View
                    key={tech}
                    className={`px-4 py-2 rounded-full ${isDark ? 'bg-gray-700' : 'bg-gray-100'}`}
                  >
        ...
        >
          <CardContent className="pt-6">
            <Text className="text-xl font-bold mb-2 text-center">Ready to get started?</Text>
