...
const swaggerPlugin = swagger({
  ...
  documentation: {
    info: {
      title: 'Mora Workstation API',
      version: '1.0.0',
      description: 'REST API Mora Workstation — Company, Workstation, Productivity, dan Wellness.',
    },
    tags: [
      {
        name: 'Auth',
      ...
      {
        name: 'Workstations',
        description: 'Manajemen workstation dan invite karyawan (max 4 free / 8 pro)',
      },
      {
        name: 'Subscriptions',
        description:
