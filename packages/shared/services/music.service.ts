...
import type { MusicPlaylist, PickCreatePlaylist } from '../types/productivity.types';
...
export async function DeletePlaylist(id: string): Promise<TResponse<MusicPlaylist>> {
